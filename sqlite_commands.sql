...
INSERT INTO User (user_id, email_address, password, source, first_name, last_name, profile_picture_url, 
  ...
  VALUES
  (1, 'julius.caesar@gmail.com', 'julius.ceasar', 'APPL', 'Julius', 'Caesar', NULL, NULL, NULL, 1,1, NULL),
  ...
  (4, 'martin.sommer@gmail.com', 'martin.sommer', 'APPL', 'Martin', 'Sommer', NULL, NULL, NULL, 0,0, NULL),
  (5, 'howard.snyder@gmail.com', 'howard.snyder', 'APPL', 'Howard', 'Snyder', NULL, NULL, NULL, 0,0, NULL),
  (6, 'margaret.smith@gmail.com', 'margaret.smith', 'APPL', 'Margaret', 'Schmit', NULL, NULL, NULL, 0,0, NULL),
  ...
  (9, 'annette.roulet@gmail.com', 'annette.roulet', 'APPL', 'Annette', 'Routlet', NULL, NULL, NULL, 0,0, NULL),
